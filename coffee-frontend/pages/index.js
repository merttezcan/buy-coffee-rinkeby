...
export default function Home() {
   ...
   */
  const contractAddress = "0x43561662017a4655618FffaC07D528040C72772b";
    ...
    <div className="flex flex-col bg-gray-900 items-center justify-center min-h-screen py-2">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <h1 className="text-xl font-bold text-white mb-6">
          CS Student - Blockchain Developer
        </h1>
        ...
        {allCoffee.map((coffee, index) => {
          return (
            <div className="border-l-2 mt-10" key={index}>
              <div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-gray-700 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
